def get_board_members():
    ...
    "president": {
        ...
        "board_member_image": "images/board_member_images/president.jpeg",
    ...
    "vice_president": {
        ...
        "board_member_image": "images/board_member_images/vice-president.jpg",
    ...
    "head_of_legal_affairs": {
        ...
        "board_member_image": "images/board_member_images/legal-affairs.jpg",
    ...
    "chief_of_staff": {
        ...
        "image": "staff.jpeg",
        "board_member_image": "images/board_member_images/staff.png",
    ...
    "head_of_finance": {
        ...
        "name": "Elias Henke",
        "image": "finance.jpg",
        "board_member_image": "images/board_member_images/finance.jpg",
    ...
    "head_of_academic_affairs1": {
        ...
        "board_member_image": "images/board_member_images/academic-affairs.jpg",
        "short_description": "As Co–Head of Academic Affairs, I develop and plan how knowledge about crypto is shared throughout the society. My goal is to both let beginners and advanced students emerse into the realm of Crypto & Blockchain.",
    ...
    "head_of_marketing": {
        ...
        "board_member_image": "images/board_member_images/marketing.jpg",
    ...
    "head_of_events1": {
        ...
        "image": "socials.jpeg",
        "board_member_image": "images/board_member_images/socials.jpg",
